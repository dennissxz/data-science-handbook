...
- [Balls and Boxes](#balls-and-boxes)
  - [Distinct Balls and Identical Boxes](#distinct-balls-and-identical-boxes)
    - [Non-empty Boxes](#non-empty-boxes)
    - [Empty Boxes](#empty-boxes)
  - [Distinct Balls and Distinct Boxes](#distinct-balls-and-distinct-boxes)
    - [Non-empty Boxes](#non-empty-boxes-1)
    - [Empty boxes](#empty-boxes)
  - [Identical Balls and Identical Boxes](#identical-balls-and-identical-boxes)
    - [Non-empty Boxes](#non-empty-boxes-2)
    - [Empty Boxes](#empty-boxes-1)
  - [Identical Balls and Distinct Boxes](#identical-balls-and-distinct-boxes)
    - [Non-empty Boxes](#non-empty-boxes-3)
    - [Empty Boxes](#empty-boxes-2)
